...
// the screenshots are not a check: WebKit renders differently across
// platforms, so a pixel diff would flake. The images are regenerated by
// hand when the UI changes, as the icons are.
