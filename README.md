...
The Parent view is also where progress is erased. Erasing clears everything: every level, the gems earned and the balance, the badges, the characters unlocked and the drill records. There is no undo.
