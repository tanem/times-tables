...
- **Character**: the figure that reacts to the learner's practice: a dragon, a cat, a robot, an owl, a unicorn or a monster. The dragon is there from the start and each of the others unlocks for good at a gem total. The learner chooses among the unlocked ones on the Start screen.
