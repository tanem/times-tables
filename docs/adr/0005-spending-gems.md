...
- **Bond** counts the finished drills done with each character, and a quit drill adds nothing. A bond pose opens at 10, 25 and 50. It is stored, since the drill records do not hold the character.
